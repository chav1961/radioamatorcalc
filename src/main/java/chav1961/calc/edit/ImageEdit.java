...
public class ImageEdit {
	...
	public enum DrawMode {
		PEN, BRUSH, ERASE, TEXT, LINE, ELLIPSE, RECT 
	}
	DrawMode	rezhim;
//    int  rezhim=0;
    int  xPad;
    ...
    public ImageEdit()
    {
        ...
        JToolBar toolbar = SwingUtils.toJComponent(xda.byUIPath(URI.create("ui:/model/navigation.top.modeBar")), JToolBar.class);
//        		
//        		
//        		new  JToolBar("Toolbar", JToolBar.VERTICAL);
//           
...
//           
    ...
    public void chooseMode(final Hashtable<String,String[]> modes) {
		rezhim = DrawMode.valueOf(modes.get("mode")[0]);
    }
	
	private void setColor(final Color color) {
        colorbutton.setBackground(maincolor = color);
	}
