...
public class ResonantTubeFactory implements PluginInterface<ResonantTubePlugin>{
	private static final String	PLUGIN_NAME = "menu.curcuits.resonant.tube"; 
	...
	@Override
	public ResonantTubePlugin newIstance(final LoggerFacade facade) {
		return new ResonantTubePlugin(facade);
	}
