...
public class TimbreFactory implements PluginInterface<TimbrePlugin>{
	private static final String	PLUGIN_NAME = "menu.curcuits.timbre"; 
	...
	@Override
	public TimbrePlugin newIstance(final LoggerFacade facade) {
		return new TimbrePlugin(facade);
	}
