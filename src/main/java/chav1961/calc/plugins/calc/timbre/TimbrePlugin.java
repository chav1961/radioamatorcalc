...
@PluginProperties(width=500,height=460,leftWidth=250,svgURI="schema.SVG,schema1.SVG",pluginIconURI="frameIcon.png",desktopIconURI="desktopIcon.png",resizable=false)
