...
public class SuperGetFactory implements PluginInterface<SuperGetPlugin>{
	private static final String	PLUGIN_NAME = "menu.curcuits.superget"; 
	...
	@Override
	public SuperGetPlugin newIstance(final LoggerFacade facade) {
		return new SuperGetPlugin(facade);
	}
