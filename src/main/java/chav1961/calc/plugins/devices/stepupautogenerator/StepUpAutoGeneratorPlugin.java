...
@Action(resource=@LocaleResource(value="chav1961.calc.plugins.devices.stepupautogenerator.button",tooltip="chav1961.calc.plugins.devices.stepupautogenerator.button.tt"),actionString="calculate")
