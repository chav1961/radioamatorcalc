...
public class RingPulseTransFactory implements PluginInterface<RingPulseTransPlugin>{
	private static final String	PLUGIN_NAME = "menu.details.ringpulsetrans"; 
	...
	@Override
	public RingPulseTransPlugin newIstance(final LoggerFacade facade) {
		return new RingPulseTransPlugin(facade);
	}
