...
// https://coderanch.com/t/570343/engineering/Alternatives-sun-security
// https://stackoverflow.com/questions/50250582/convert-pkcs1-formatted-private-key-to-pkcs8-formatted-private-key-by-java
...
fos.close();
    ...
    public static void main(String[] args) throws Exception {
        ...
        String s= Base64.getEncoder().encodeToString(gcsr.getPrivateKey().getEncoded());
        ...
        String s1=Base64.getEncoder().encodeToString(gcsr.getPrivateKey().getEncoded());
