...
public class JControlFalse extends JControlLabel {
	...
	public JControlFalse(final ContentNodeMetadata metadata, final PipeContainerInterface owner) throws ContentException {
		super(FALSE_CONTROL_ICON,metadata,owner);
	}
}
