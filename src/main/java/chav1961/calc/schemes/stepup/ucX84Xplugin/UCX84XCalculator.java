...
@LocaleResourceLocation(Localizer.LOCALIZER_SCHEME+":prop:chav1961/calc/schemes/stepup/ucX84Xplugin/ucX84X")
...
class UCX84XCalculator implements FormManager<Object,UCX84XCalculator> {
	...
	private static final String[]	FIELDS_ANNOTATED = chav1961.calc.environment.Utils.buildFieldsAnnotated(UCX84XCalculator.class); 
...
@Format("10.3r")
	...
	UCX84XCalculator(final Localizer localizer,final LoggerFacade logger) {
		this.localizer = localizer;
		this.logger = logger;		
	}
	
	@Override
	public RefreshMode onRecord(final Action action, final UCX84XCalculator oldRecord, final Object oldId, final UCX84XCalculator newRecord, final Object newId) throws FlowException, LocalizationException {
		switch (action) {
			case CHECK	:
	...
	@Override
	public RefreshMode onField(final UCX84XCalculator inst, final Object id, final String fieldName, final Object oldValue) throws FlowException, LocalizationException, IllegalArgumentException {
		switch (fieldName) {
			case "innerVoltage"		:
	...
	@Override
	public RefreshMode onAction(final UCX84XCalculator inst, final Object id, final String actionName, final Object parameter) throws FlowException, LocalizationException {
		switch (actionName) {
			case "calculate"	:
