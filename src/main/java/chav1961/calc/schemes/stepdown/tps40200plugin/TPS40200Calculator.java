...
@LocaleResourceLocation(Localizer.LOCALIZER_SCHEME+":prop:chav1961/calc/schemes/stepdown/tps40200plugin/TPS40200")
...
class TPS40200Calculator implements FormManager<Object,TPS40200Calculator> {
...
@Format("10.3r")
	...
	TPS40200Calculator(final Localizer localizer,final LoggerFacade logger) {
		this.localizer = localizer;
		this.logger = logger;		
	}
	
	@Override
	public RefreshMode onRecord(final Action action, final TPS40200Calculator oldRecord, final Object oldId, final TPS40200Calculator newRecord, final Object newId) throws FlowException, LocalizationException {
		switch (action) {
			case CHECK	:
	...
	@Override
	public RefreshMode onField(final TPS40200Calculator inst, final Object id, final String fieldName, final Object oldValue) throws FlowException, LocalizationException, IllegalArgumentException {
		switch (fieldName) {
			case "innerVoltage"		:
	...
	@Override
	public RefreshMode onAction(final TPS40200Calculator inst, final Object id, final String actionName, final Object parameter) throws FlowException, LocalizationException {
		switch (actionName) {
			case "calculate"	:
