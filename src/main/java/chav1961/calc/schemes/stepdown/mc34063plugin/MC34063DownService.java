...
public class MC34063DownService implements PluginInterface {
	...
	private static final String[]	RECOMMENDED_PATH = {"menu.schemes","stepdown", "mc34063"};

	private MC34063					inner = null;
	
	public MC34063DownService() {
	}
	...
	public String[] getTagsIds(final Localizer parent) throws LocalizationException {
		return new String[]{"MC34063DownService.tag1","MC34063DownService.tag2"};
	}
