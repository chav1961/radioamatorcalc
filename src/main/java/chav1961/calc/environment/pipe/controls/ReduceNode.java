...
public class ReduceNode implements PipeControlInterface, PluginInterface {
	private static final URL				LEFT_ICON_RESOURCE = ReduceNode.class.getResource("ReduceNode.png");
	...
	public ReduceNode(final Localizer localizer) {
	...
	public PluginInstance newInstance(final Localizer localizer, final LoggerFacade logger) throws LocalizationException, SyntaxException, ContentException, IOException {
		return new ReduceContent(this,localizer);
	}

	@Override
	public String getPluginId() {
		return Constants.PIPE_REDUCE_NODE;
	}
